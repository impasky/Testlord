...
| Dünya'da "Bu bölgeyi bırak" TEK dokunuşta çalışıyor — bot başkenti bıraktı, şehir kademesi düştü, dört kapı kilitlendi | Geri dönüşü olmayan karar onaysızdı (hesap silme ve taraf değiştirme iki dokunuş istiyor)                                   | İlk dokunuş soruyor, başkentse bunu ayrıca söylüyor; "Evet, bırak" bırakıyor. `harita-testi` iki dokunuşu ve Vazgeç'i sınıyor                                   |
| Başkentini bırakan lord, elinde köy olsa bile kampa düşüyor; sonraki fetihler de başkent olmuyor                       | Bırakma ucu, fetihte başkenti taşıyan yolu (`baskentiDusur`) atlıyordu; lordun kaydında sahipsiz bölgenin kimliği kalıyordu | Uç `baskentiDusur`'u çağırıyor. `sehir-testi` başkenti artık test ucundan değil gerçek uçtan bırakıyor ve köye taşındığını sınıyor (düzeltme olmadan KALDI)     |
| Bir bölgeye bakan herkes, sahibinin bütün bina seviyelerini ve başkentini okuyabiliyor                                 | `/map/:id` sahibi `...region` ile olduğu gibi döndürüyordu; liste ucu zaten kırpıyordu                                      | Yanıtta sahip yalnız `{id, ad, seviye}`; `denetim-testi` alanları sayıyor                                                                                       |
