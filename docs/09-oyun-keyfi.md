...
| B2  | ~~**Sezon**~~ **YAPILMAYACAK — yerine BİRLEŞME** | Dünya hâlâ KALICI, sıfırlama yok. Ama sezonun çözdüğü bir sorun sıfırlamasız çözülmüyordu: zaman geçtikçe diyar boşalıyor ve "dolu" göründüğü için kapısı da kapalı kalıyor. Birleşme bunu sıfırlamadan çözüyor — 60 günü dolan diyar, **açılış tarihi yakın** bir yaşıtıyla birleşiyor. Kimsenin ilerlemesi silinmiyor: lord, ordu, araştırma, binalar taşınıyor; toprak ancak yeri doluysa düşüyor ve bir günlük geliriyle tazmin ediliyor. Taht sıfırlanıyor — iki "Diyarın Lordu"ndan birinin unvanını kavgasız almak yerine ikisi de yeniden yarışıyor. | **Kapasite de aktife bakıyor:** diyar, AKTİF lordu kapasiteye ulaşınca doluyor — kayıtlıyı saymak, bir yıl önce bırakmış oyuncular yüzünden diyarı yeni gelene kapatıyordu (142 kayıtlı / 6 aktif bir diyar "dolu" görünüyordu). Birleşme bunu 60 günde bir, kapasite ölçütü her gün çözüyor; ikisi birbirinin alternatifi değil. |
